// ============================================================
// compare_portfolio_parity.ts
//
// Runs Tier 1 Math Backtesters (Mage, Sage) for all active pairs,
// runs Tier 2 Portfolio Shadow Backtester (multi-pair LiveOrchestrator),
...
async function main() {
  ...
  const shadowTradesRaw = await runPortfolioShadowBacktest(startDate, endDate);
