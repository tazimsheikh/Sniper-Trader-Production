...
async function runOptimizer() {
  const pairs = [
    ...
    'USDCAD_M1_202105030000_202605010159.csv',
    'NZDUSD_M1_202105030000_202605010159.csv',
  ];
  ...
  for (const pairStr of pairs) {
    ...
    // SAFE TRADING PARAMETERS V3
    const riskPcts = [5]; // Realistic risk compounding
    const emaPeriods = [60, 240]; // 1H and 4H trend alignment
    const entryHours = [1, 2, 8, 9, 13, 14]; // Asian, London & NY Open
    const entryMins = [0, 15, 30]; 
    const slPipsOptions = [10, 15, 20]; // Strong hard stops
    const tpPipsOptions = [15, 30, 45]; // Fixed targets
