...
const trades = await client.query("SELECT id, profile_id, bot_id, broker_symbol, status, open_time, lots FROM bot_trade_states WHERE profile_id = 43 ORDER BY open_time DESC LIMIT 10");
